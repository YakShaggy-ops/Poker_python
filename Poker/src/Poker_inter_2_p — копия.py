...
from winers_inter import show_winner_window
...
class Ui_MainWindow(QMainWindow):
    ...
    def player_wins(self, player):
        ...
        self.final_player(turn, players)
        ...
        #     self.Player_2_bet_numb.setText(str(new_p_bank))
        ...
        #     self.Player_1_bet_numb.setText(str(new_p_bank))
    ...
    def final_player(self, turn, players):
        self.text_console(turn, 'You win round!')
        if turn == 0:
            a = self.Player_1_bet_numb.text()
            b = self.Player_2_bet_numb.text()
        ...
        #     #print('turn =', turn)
        #     self.player_wins_2()
        #     players[1].player_money = int(self.Player_1_bank_numb.text())
        #     print(players[1].player_money, players[0].n_bet, players[1].n_bet)
        #     players[1].player_money += players[0].n_bet + players[1].n_bet
        #     print(players[1].player_money)
        #     self.Player_2_bet_numb.setText(str(players[1].player_money))
        #     print(players[1].player_money)
        #     time.sleep(1)
        #     print(players[1].player_money)
        #     MainWindow = QtWidgets.QMainWindow()
        ...
        #     MainWindow.show()
        # elif turn == 1:
        #     self.Player_2_console.setText('you wins round')


        #show_winner_window(players[turn].player_name)
        ...
        if self.isbetsame_i() and self.player_bets_counter >= tim_len:
            ...
            if self.game_pos == 0:
                ...
                if len(pla) == 1:
                    ...
                    for el in pla:
                        print('P_I', el.player_name)

            elif self.game_pos == 4:
                winer = get_wins_player_i()
